    ...
    <section id="contact" className="py-32 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-24 items-start">
          <motion.div {...fadeInUp}>
            <h2 className="text-5xl md:text-8xl font-black tracking-tighter mb-12 uppercase italic leading-none transition-colors text-brand-ink">INITIALIZE<br /><span className="text-brand-muted opacity-30">WORKFLOW</span></h2>
            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <p className="text-xl font-black uppercase italic text-brand-ink">hello@nexus.systems</p>
              </div>
            </div>
          </motion.div>
