      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          <div className="w-6 h-6 bg-brand-ink flex items-center justify-center transition-colors">
            <span className="text-brand-bg font-black text-xs transition-colors">N</span>
          </div>
          <span className="text-sm font-black tracking-[0.2em] text-brand-ink transition-colors">NEXUS</span>
        </Link>
